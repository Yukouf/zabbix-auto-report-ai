...
Projet développé dans le cadre d'un déploiement SOC/supervision en production (Mastère Cybersécurité). Voir aussi : [Wazuh-CVE-Alerter](https://github.com/Yukouf/Wazuh-CVE-Alerter).
